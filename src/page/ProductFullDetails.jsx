...
function ProductFullDetails() {
  ...
  const filteredData = Data.filter((item) => item.id === parseInt(proId));
        ...
        <div className="flex flex-wrap -mx-4" key={index}>
          ...
          <div className="w-full md:w-1/2 px-4 mb-8">
            <img
              src={item.img}
              alt="Product"
              className="w-full h-[60vh] rounded-lg shadow-md mb-4"
              id="mainImage"
            />
          ...
          <div className="w-full md:w-1/2 px-4">
            <h2 className="text-3xl font-bold mb-2">Premium {item.title}</h2>
            <p className="text-gray-600 mb-4">SKU: WH1000XM4</p>
            <div className="mb-4">
              <span className="text-2xl font-bold mr-2">${item.newPrice}</span>

export const Footer = () => {
  return (
    <div className="relative mt-16 bg-gray-200">
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <p className="text-sm text-center text-gray-800 border-t-[1px] p-4 border-rose-400">
          © Created by ROHIT RAJPUT using Shadcn.
        </p>
      </div>
    </div>
  );

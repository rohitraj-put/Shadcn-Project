...
function Home() {
  return (
    <>
      ...
      <section className="pt-6  text-gray-800">
        <div className=" mx-auto flex flex-col justify-around p-4 text-center md:py-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracking-widest uppercase text-rose-500">
              Hic eligendi necessitatibus quod quia
            </p>
            <h1 className="py-2 text-3xl font-bold leading-tight title-font uppercase ">
          ...
          <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            <button className="inline-flex items-center px-6 py-3 rounded-lg bg-rose-500 text-white">
              <svg
            ...
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-rose-500 text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                className="fill-current w-7 h-7 text-white"

...
function ProductFullDetails() {
  ...
  const filteredData = Data.find((item) => item.id === parseInt(proId));

  const sameCategoryProducts = Data.filter(
    (item) =>
      item.category === filteredData.category && item.id !== filteredData.id
  );
      ...
      <div className="flex flex-wrap -mx-4">
        ...
        <div className="w-full md:w-1/2 px-4 mb-8">
          <img
            ...
            alt="Product"
            className="w-full h-[60vh] object-fill rounded-lg shadow-md mb-4"
            id="mainImage"
          />
          <div className="flex gap-4 py-2 justify-center overflow-x-auto">
            <img
              ...
              alt="Thumbnail 1"
              className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-80 hover:opacity-100 transition duration-300"
        ...
        <div className="w-full md:w-1/2 px-4 overflow-y-auto h-[calc(100vh-8rem)] scrollbar">
          ...
          <div className="mb-4">
            <span className="text-2xl font-bold mr-2">
              ${filteredData.newPrice}
            </span>
            <span className="text-gray-500 line-through">
              ${filteredData.oldPrice}
            </span>
          </div>

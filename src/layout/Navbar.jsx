    ...
    <>
      <div className="bg-white sticky top-0 z-30">
        ...
        <header className="relative bg-white">
          <p className="py-2 text-center bg-red-500 text-sm text-white px-4">
            FREE SHIPPING on All Gift Hampers + Handwritten Notecards with
                ...
                <div className="ml-auto flex items-center">
                  ...
                  <div className="flex lg:ml-2">
                    <HoverCard>
                      ...
                      <HoverCardContent className="w-80 mt-[16px] ">
                        <div className="text-center my-2 ">
                          <img
                            className="h-32 w-32 rounded-full border-4 mx-auto my-4"
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                    <Sheet>
                      <SheetTrigger asChild>
                        <ShoppingBagIcon
                          aria-hidden="true"
                          className="size-6 shrink-0 text-gray-400 cursor-pointer group-hover:text-gray-500"
                        />
                      </SheetTrigger>
                      <SheetContent>
                        <SheetHeader>
